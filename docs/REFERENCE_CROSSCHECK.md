...
| **SW-1** | Qiskit 2.5.2 | `docs/FACTCHECK_LOG.md`, `Makefile`, `NOTICE`, `docs/CLEANROOM.md`, `docs/COMPLIANCE_CHECKLIST.md`, `docs/CREDENTIALS.md` and 15 more |
| **SW-2** | Qiskit Machine Learning 0.9.1 | `Makefile`, `NOTICE`, `docs/CLEANROOM.md`, `docs/COMPLIANCE_CHECKLIST.md`, `docs/CREDENTIALS.md`, `docs/ENVIRONMENT.md` and 15 more |
...
| **SW-6** | XGBoost 3.4.1 | `Makefile`, `NOTICE`, `docs/CLEANROOM.md`, `docs/CREDENTIALS.md`, `docs/ENVIRONMENT.md`, `docs/FACTCHECK_LOG.md` and 18 more |
