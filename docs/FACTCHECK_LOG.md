...
| 19 | QIntern: "135 checks green at that freeze" | `git grep -h "def test_" <freeze> -- '*/tests/*.py' \| wc -l` = 135; at `HEAD` = 183 | **supported** | Exact. No `parametrize` in the suite, so defined equals collected. The proposal's "at that freeze" hedge is correct |
