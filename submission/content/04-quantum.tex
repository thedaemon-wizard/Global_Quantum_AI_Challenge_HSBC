...
point. On \ClaimScreenSamples{} stratified rows with at most eight features, no configuration
...
\[
f(\mathbf{x}) = \sum_{\{s\}} A^{s_1} \cdots A^{s_N} \prod_j \phi^{s_j}(x_j),
\qquad \phi(x) = \bigl[\cos\tfrac{\pi x}{2},\ \sin\tfrac{\pi x}{2}\bigr],
\]
sweeping the bond dimension $\chi$
