...
could construct is to within measurement a classical RBF in disguise --- which reporting a
downstream accuracy would have hidden. One caveat: the protocol names the Huang geometric
...
less decisive, not more. The closest published comparator agrees: a controlled benchmark on real
