...
usable band --- \emph{and} not reproducible by a tuned RBF, where $\rho_{\mathrm{RBF}}$ is the
largest absolute off-diagonal correlation over a bandwidth grid and must fall below 0.60.
