...
is a precision with no recall and no base rate. Neither tests distinctness from a classical
kernel before scoring, which is where this section stops. The comparator that does control for that agrees with us:
