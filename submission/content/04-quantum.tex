...
\Cited{0.88} $F_1$ \Cited{(Deloitte and AWS, 2024; Karimi et al., 2024)}; both report a
downstream score without first testing distinctness from a classical kernel, and neither states
a search budget for its classical arm. The comparator that does control for that agrees with us:
