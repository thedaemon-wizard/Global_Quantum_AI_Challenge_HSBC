...
$\Dtest$. The \textbf{selective} break is that band membership is a data-dependent event, if
the edges were estimated on the data used to certify. Freezing the edges on $\Dband$ removes
the second by construction: membership becomes a fixed measurable predicate, and filtering a
sequence by one preserves exchangeability of what remains. Only the temporal break survives,
and we measure it.
