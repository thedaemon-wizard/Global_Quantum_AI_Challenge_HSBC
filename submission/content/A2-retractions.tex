...
The decision log records thirty-one entries. These are the ones that changed a result, listed
...
and their measured standard error (\ClaimMpsStandardErrorBestChi) is about eightfold larger
than the seed-to-seed figure. The gate passed a comparison it should have flagged. It now
computes a cross-family proxy and binds on the larger, and H4 is reported as underpowered.
